...
V2.7: The complete, classic foundation.

V4.0.1: The refined, high-performance engine upgrade with a "Time Axis" for logic.
...
Displays the Master Index (The current system map).
...
/MAS_V2_7_Classic/: The original, complete architecture.

/MAS_V4_BETA/: The new, high-performance "Axonal Bridge" implementation.
